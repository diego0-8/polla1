...
$router->post('/admin/matches/manual/events', [AdminMatchDataController::class, 'addEvent'], $adminMw);
$router->post('/admin/matches/manual/events/delete', [AdminMatchDataController::class, 'deleteEvent'], $adminMw);

...
final class LeaderboardController extends Controller
{
    public function index(): void
    {
        ...
        $rows = UserPoints::attachParticipationStats($rows, $season);
        $rows = UserPoints::attachLastMatchBreakdown($rows, $season);

        View::render('leaderboard/index', [
            'rows' => $rows,
            'season' => $season,
            'matchesPlayed' => MatchModel::countFinishedForSeason($season),
            'prizes' => $prizes,

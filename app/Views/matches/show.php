...
<div class="row g-3">
  <div class="col-12 col-lg-7">
    <div class="d-flex align-items-center justify-content-between mb-2 flex-wrap gap-2">
      ...
      <span class="small text-muted">Mundial <?= MatchView::season() ?></span>
    </div>
        ...
        <div class="card p-3">
          <?php if (!$events): ?>
            <div class="text-muted">
              Todavía no hay registros. Espere a que comience la competición.
            </div>
          <?php else: ?>
      ...
      <div class="tab-pane fade" id="tabInfo" role="tabpanel">
        <div class="card p-3">
          <dl class="mb-0 match-info-dl">
            ...
            <dd class="mb-2"><?= htmlspecialchars(trim((string)($match['venue'] ?? '')) !== '' ? (string)$match['venue'] : 'Por confirmar') ?></dd>
      ...
      <?php else: ?>
        <form method="post" action="<?= htmlspecialchars(Url::to('/predictions')) ?>" class="vstack gap-2">
          ...
          <label class="prediction-outcome-option">
            ...
            <span class="badge badge-ft ms-1">2 pts</span>
          </label>
          <label class="prediction-outcome-option">
